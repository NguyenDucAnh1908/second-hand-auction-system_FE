...
import { Avatar, Descriptions, Image, Space } from 'antd';
...
function AuctionDetailAdmin({ itemIds }) {
                    ...
                    <div className="self-stretch">
                        <div className="flex items-center w-full gap-[34px] md:flex-col">
                            <div className="flex-1 bg-green-50 rounded-2xl p-6 flex flex-col gap-4">
                                <Descriptions
                                    title={<div className="w-full text-center text-xl font-semibold">Thông tin sản phẩm</div>} 
                                    layout="vertical" 
                                    items={items}
                                />
                                <Descriptions
            ...
            <div className="flex flex-row w-full justify-between gap-8 mt-5">
                ...
                <div className="flex flex-col items-center bg-blue-50 p-6 rounded-2xl w-1/2">
                    ...
                    <div className="w-full flex justify-center">
                        <div className="mb-8 flex flex-col items-center gap-6 bg-white p-5 rounded-2xl shadow-md max-w-4xl w-full">
...
export default AuctionDetailAdmin;
