                    ...
                    <div className="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
                        <div className="min-w-0 flex-1 space-y-8">
                            <div className="space-y-4">
                                <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Thông tin đơn hàng</h2>
                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            >
                                                ...
                                                <svg fill="none" aria-hidden="true" className="me-2 h-4 w-4" viewBox="0 0 20 15">
                                                    ...
                                                    <path fill="#FFDA44" d="M9.8 4.2l1.18 3.63h3.82l-3.1 2.25 1.18 3.63L9.8 10.46l-3.1 2.25 1.18-3.63-3.1-2.25h3.82L9.8 4.2z" />
                                                </svg>
                                                +84
                                                {/* Mũi tên dropdown */}
                                    ...
                                    <div>
                                        <label htmlFor="company_name" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Ghi chú </label>
                                        <input type="text"

                                            value={orderDetails.note}
                                            onChange={(e) => setOrderDetails({ ...orderDetails, note: e.target.value })}
                                            className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" placeholder="Ghi chú" required />
                                    </div>
                                </div>
                                <div>
                                    <div className="mb-2 flex items-center gap-2">
                                        <label htmlFor="select-city-input-3" className="block text-sm font-medium text-gray-900 dark:text-white"> Tỉnh/Thành phố* </label>
                                    </div>
                                    <input
                                        type="text"

                                        value={addressData?.province_name || ""}
                                        className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" required />
                                </div>
                                <div>
                                    <div className="mb-2 flex items-center gap-2">
                                        <label htmlFor="select-city-input-3" className="block text-sm font-medium text-gray-900 dark:text-white"> Huyện/Quận </label>
                                    </div>
                                    <input type="text"
                                ...
                                <div>
                                    <div className="mb-2 flex items-center gap-2">
                                        <label htmlFor="select-city-input-3" className="block text-sm font-medium text-gray-900 dark:text-white"> Phường/Xã </label>
                                    </div>
                                    <input type="text"
                            ...
                            <div className="space-y-4">
                                <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Phương thức giao hàng</h3>
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                            ...
                            <div className="flow-root">
                                <div className="-my-3 divide-y divide-gray-200 dark:divide-gray-800">
                                    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Thông tin sản phẩm</h3>
                                        <img className="rounded-t-lg w-full object-cover h-56" src={auctionData?.data.thumbnail || "/docs/images/blog/image-1.jpg"} alt={auctionData?.data.itemName || "Image"} />
                                        <div className="p-5">
                                            ...
                                            <p className="text-lg text-gray-800 font-semibold mb-3">
                                                Người bán: <span className="text-blue-600">{auctionData?.data.seller}</span>
                                            </p>
                            ...
                            <div className="space-y-3">
                                <button
                                    ...
                                    text-black bg-gradient-to-t from-blue-400 to-blue-600 
                                     ...
                                     ${isLoading || auctionLoading ? 'cursor-not-allowed opacity-50' : ''}`}                             >
