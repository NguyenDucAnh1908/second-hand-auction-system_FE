                                ...
                                <TabPanel>
                                    <div className="grid grid-cols-1 gap-6 w-full">
                                        ...
                                        <div className="flex flex-col gap-1.5">
                                            ...
                                            <label
                                                htmlFor="cccd-upload"
                                                className="cursor-pointer rounded-md border border-gray-300 px-4 py-2 text-blue_gray-900_01 bg-white shadow-sm transition-colors hover:bg-gray-100"
                                            >
                                                Chọn ảnh
                                            </label>
                                            <input
                                            ...
                                            {uploadedImage && (
                                                <div className="mt-2">
                                                    <img src={uploadedImage} alt="Uploaded" className="w-32 h-32 object-cover" />
                                                </div>
                                            )}
                                        </div>
                                    </div>
