        ...
        <div>
            <div className="p-6 bg-gray-100 min-h-screen">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md mb-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <p><strong>Mã đơn khách hàng:</strong> {selectedOrder?.item.itemId} </p>
                        <p><strong>Sản phẩm:</strong> {selectedOrder?.item.itemName} </p>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md mb-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <p><strong>Mã đấu giá:</strong> {selectedOrder?.auctionOrder.auctionId} </p>
                        <p><strong>Kiểu dấu giá:</strong> {selectedOrder?.auctionOrder.auctionTypeName}</p>
                        <p><strong>Số tiền đấu giá:</strong> {selectedOrder?.totalPrice} </p>
                        <p><strong>Bước giá:</strong> {selectedOrder?.auctionOrder.priceStep} </p>
                        <p><strong>Trạng thái:</strong> {selectedOrder?.auctionOrder.status} </p>
                        <p><strong>Điều khoản:</strong> {selectedOrder?.auctionOrder.termConditions} </p>
                    </div>
                </div>
