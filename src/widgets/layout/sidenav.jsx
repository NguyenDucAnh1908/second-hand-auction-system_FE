...
export function Sidenav({ brandImg, brandName, routes }) {
  ...
  return (
      ...
      >
        ...
        <div className="m-4 overflow-y-auto h-[calc(100vh-32px-64px)]"> {/* Adjust height for the scrollable area */}
                ...
                {title && (
                    ...
                    >
                      ...
                      {expandedSections[key] ? (
                          <ChevronUpIcon className="h-4 w-4 text-blue-gray-500" />
                      ) : (
                          <ChevronDownIcon className="h-4 w-4 text-blue-gray-500" />
                      )}
                    </li>
                )}
